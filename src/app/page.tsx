...
export default function Home() {
  return (
    <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
      ...
      <h2 className="font-[family-name:var(--font-heading)] text-2xl md:text-3xl font-semibold text-stone-700 mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl w-full">
        {storyTemplates.map((template) => (
          <Link
            ...
            className="group block bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-200 hover:-translate-y-1 border-2 border-stone-200 hover:border-amber-400 overflow-hidden"
          >
